    ...
    function _bind(options, cb) {
        ...
        return loadImage(url, hasExif).then(function (img) {
            ...
            if (!points.length) {
                ...
                var aspectRatio = 1;//rect.width / rect.height;
                var imgAspectRatio = 1;//natDim.width / natDim.height;
                var width, height;
//alert(natDim.width+' - '+natDim.height);
    ...
    function _result(options) {
        ...
        if (size === 'viewport') {
            data.outputWidth = self.options.resultimg.width;//vpRect.width;
            data.outputHeight = self.options.resultimg.height;//vpRect.height;
            
//alert(self.options.resultimg.width);
