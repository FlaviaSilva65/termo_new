<div class="container">
    ...
    <?= $this->Form->create($unidEscolares); ?>

    <div class="row mt-5 mb-2 mx-0 d-flex justify-content-center">
        <div class="col-4">
            <?= $this->Form->control('nm_unid_escolar', ['label' => ['text' => 'Unidade Escolar', 'class' => 'text-white']]); ?>
        </div>
        <div class="col-4">
            <?= $this->Form->control('setores_id', ['label' => ['text' => 'Setor', 'class' => 'text-white'], 'empty' => '---', 'options' => $setores]); ?>
        </div>
