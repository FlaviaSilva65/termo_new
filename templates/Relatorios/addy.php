    ...
    <div class="col-12 d-flex justify-content-between flex-wrap">
        <div class="col-12 col-md-4 pe-md-3 mt-4">
            ...
            <div class="col-12 d-flex flex-wrap">
                ...
                <?php foreach ($list_ocorrencia as $i => $ocorrencia) : ?>
                        ...
                        <div class="col-6 col-md-6 bg-striped my-1">
                            <div class="p-2 ">
                                ...
                                echo $this->Form->control(
                                    'ocorrencia_relatorios.' . $i . '.ocorrencia_id',
                                    [
                                        'value' => $ocorrencia->id,
                                        'hiddenField' => false,
                                        'type' => 'checkbox',
        ...
        <div class="col-12 col-md-8 ps-md-3 mt-4">
            ...
            <div class="col d-flex flex-wrap">
                ...
                <?php foreach ($list_ocorrencia as $x => $ocorrencia) : ?>
                    <?php if ($ocorrencia->categorias_id == 4) { ?>
                        ...
                        <div class="col-12 col-md-4 text-start bg-striped my-1">
                            <div class="p-2 ">
                                ...
                                echo $this->Form->control(
                                    'ocorrencia_relatorios.' . $x . '.ocorrencia_id',
                                    ['value' => $ocorrencia->id, 'hiddenField' => false, 'type' => 'checkbox', 'class' => 'me-2 formcontrol', 'id' => 'formGroupManut', 'label' => $ocorrencia->nm_tp_ocorrencia]
                                );
