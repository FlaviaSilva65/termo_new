<div class="col-11 col-lg-11 mx-auto bg-white d-flex justify-content-between my-2 rounded-3 flex-wrap poppins">
    <div class="d-flex ps-3 align-items-center">
        <span class='fs-4 fslh1 border border-1 border-white rounded-0 ps-5 py-2  form-select fs-azul bg-white'>
            <?= $escola->nm_unid_escolar;  ?></span>
    </div>
</div>
