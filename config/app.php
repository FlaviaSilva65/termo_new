...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '7663c5ecc51507aeec3a7b90e1c3163aef75744bfb7eb5774b1105464b23c498'),
    ],
    ...
    'EmailTransport' => [
        ...
        'praiagrande' => [
            // 'host' => 'localhost',
            'host' => 'mail3.praiagrande.sp.gov.br',
            'className' => 'Smtp',
            'url' => env('EMAIL_TRANSPORT_DEFAULT_URL', null),
        ],
    ],
    ...
    'Email' => [
        'default' => [
            'transport' => 'default',
            'from' => ['no-reply-seduc@praiagrande.sp.gov.br' => 'Secretaria de Educação de Praia Grande'],
            /*
    ...
    'Datasources' => [
        ...
        'bdescola' => [
            ...
            'persistent' => false,
            'host' => '192.168.0.13',
            'username' => 'webmaster', //Servidor
            'password' => '#myProdNovoMySqlR00TDB$##', //Servidor
            'database' => 'escolas',  // Servidor 
            'encoding' => 'utf8',
        ],
